...
CONTAINER=mbs-ubuntu-1610-x64-tmp
IMAGE=mbs-ubuntu-1610-x64
...
lxc launch ubuntu:16.10 ${CONTAINER}
...
lxc publish ${CONTAINER} --alias=${IMAGE} description="This image contains the build environment for the MBS system on Ubuntu 16.10 64 bit."
