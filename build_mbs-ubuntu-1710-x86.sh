...
CONTAINER=mbs-ubuntu-1710-x86-tmp
IMAGE=mbs-ubuntu-1710-x86
...
lxc publish ${CONTAINER} --alias=${IMAGE} description="This image contains the build environment for the MBS system on Ubuntu 17.10 32 bit."
