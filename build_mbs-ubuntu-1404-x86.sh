...
CONTAINER=mbs-ubuntu-1404-x86-tmp
IMAGE=mbs-ubuntu-1404-x86
...
lxc launch ubuntu:14.04/i386 ${CONTAINER}
...
lxc publish ${CONTAINER} --alias=${IMAGE} description="This image contains the build environment for the MBS system on Ubuntu 14.04 32 bit."
