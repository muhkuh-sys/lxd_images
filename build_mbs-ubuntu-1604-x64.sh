...
CONTAINER=mbs-ubuntu-1604-x64-tmp
IMAGE=mbs-ubuntu-1604-x64
...
lxc publish ${CONTAINER} --alias=${IMAGE} description="This image contains the build environment for the MBS system on Ubuntu 16.04 64 bit."
